...
static const char col_gray3[]       = "#bf8c00";
/*active tab font color*/
static const char col_gray4[]       = "#ffcc00";
/*Active tab bg color and active tab window border color*/
static const char col_cyan[]        = "#00a600";
